...
public class GhostActivity extends AppCompatActivity {
    ...
    public boolean onStart(View view) {
        ...
        if (userTurn) {
            ...
            SimpleDictionary.userStarted = true;
        } else {
            SimpleDictionary.userStarted = false;
    ...
    public void challenge(View view) {
        ...
        } else if (!dictionary.isWord(wordFragment) && dictionary.getGoodWordStartingWith(wordFragment) != null) {
